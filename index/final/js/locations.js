...
const locationsList = [
    {
      ...
      difficulty: 'Easy',
      description:
        'Beautiful short location along the Bechler river to Bechler Falls',
      directions:
    ...
    },
    {
      ...
      difficulty: 'Moderate',
      description:
        'Beautiful location through Bechler meadows river to Denanda Falls',
      directions:
  ...
  export default class Locations {
    ...
    showLocationsList() {
      ...
      renderLocationsList(this.parentElement, this.getAllLocations());
      this.addLocationsListener();
    ...
    showOneLocation(locationName) {
      const location = this.getLocationsByName(locationName);
      this.parentElement.innerHTML = '';
  ...
  function renderLocationsList(parent, locations) {
    locations.forEach(location => {
      parent.appendChild(renderLocationsListLight(location));
    });
  }
  function renderLocationsListLight(location) {
